...
export const WHEEL_COUNTERCLOCKWISE_RESET = 'WHEEL_COUNTERCLOCKWISE_RESET'
export const WHEEL_CLOCKWISE_RESET = 'WHEEL_CLOCKWISE_RESET'
export const INPUT_CHANGE2 = 'INPUT_CHANGE2'
export const INPUT_CHANGE3 = 'INPUT_CHANGE3'
